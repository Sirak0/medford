    ...
    <div className="section1">
      <div className="section1-content1">
        <div className="order-uzi">
          ...
          <button
            onClick={() => {
              dispatch({ type: "getPopup", payload: firstElem });
            }}
          >
            Получить КП
          </button>
      ...
      <div className="responsive-midle">
        <div className="midle-p">
          <p>Аренда на срок от 1 мес</p>
        </div>
        <div className="midle-p">
          <p>Дешевле, чем покупка нового</p>
        </div>
        <div className="midle-p">
          <p>Официально по договору</p>
        </div>
        <div className="midle-p">
          <p>Без залогов и поручителей</p>
        </div>
        <div className="midle-p">
          <p>Поставка УЗИ в ваш кабинет от трех до семи дней</p>
        </div>
      </div>
      ...
      <div className="section1-paragrafs">
        <div className="paragraf-div">
          <h3>Инвестиции</h3>
          <p>
            Не требует больших затрат, проверки спроса на УЗИ в вашем регионе.
          </p>
        </div>
        <div className="paragraf-div">
          <h3>Срочность</h3>
          <p>Быстрая замена аппарата вышедшего из строя до покупки нового </p>
        </div>
        <div className="paragraf-div">
          <h3>Лицензия</h3>
          <p>Аренда УЗИ аппарата оптимальное решение для получения лицензии</p>
        </div>
      </div>
    </div>
  );
