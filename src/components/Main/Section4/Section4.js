    ...
    <div className="section4">
      ...
      <div className="section4-content2">
        <Slider {...settings} className="slider8">
          ...
          <div className="cont-div">
            <h3>
              Прибыльная альтернатива<br></br> лизингу и кредиту
            </h3>
            <p>Простое оформление</p>
          </div>
          <div className="cont-div">
            <h3>
              Отличный старт<br></br> для бизнеса
            </h3>
        ...
        <div className="content2-div">
          <div className="cont-div">
            ...
            <p>
              Обучение, консультации<br></br> и бесплатное обслуживание
            </p>
          </div>
          <div className="cont-div">
            <h3>
            ...
            <p>
              От одного месяца +<br></br> индивидуальные предложения
            </p>
          </div>
          <div className="cont-div">
            <h3>
            ...
            <p>
              от 25 тыс. ₽ в месяц. Выкуп.<br></br> Система скидок
            </p>
          </div>
        </div>
        <div className="content2-div">
          ...
          <div className="cont-div">
            ...
            <p>
              Оборудование окупается,<br></br> вклад в репутацию
            </p>
          </div>
        </div>
      </div>
