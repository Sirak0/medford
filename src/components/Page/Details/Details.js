        ...
        {device.images.map((elem, index) => {
          ...
          return (
            <div className="image-div" key={index}>
              {element.current === "image" ? (
                <img onClick={newImage} alt={device.name} src={elem}></img>
              ) : (
                <video
                  onClick={() => dispatch({ type: "media", payload: elem })}
                >
                  <source src={elem} type="video/mp4"></source>
                </video>
              )}
            </div>
          );
      ...
      <div className="detailed-div">
        <div className="main-image-div">
          <img
            ...
            onClick={() => {
              dispatch({ type: "media", payload: imageState });
            }}
            alt={device.name}
            src={imageState}
          ></img>
        ...
        <div className="described-div">
          ...
          <div className="advantages-div">
            <div className="advantage-div">
              <img src={Rep} alt="..."></img>
              <p>
                Оборудование прошло <br /> полное ТО по стандартам <br />
                производителя
              </p>
            </div>
            <div className="advantage-div">
              <img src={Des} alt="..."></img>
              <p>
                Произведена дезинфекция <br /> всех поверхностей <br />и
                датчиков
              </p>
            </div>
          </div>
          ...
          <div className="complect-div">
            ...
            <div className="sensors-div">
              ...
              <Slider
                {...settings}
                style={{ width: "90%", height: "200px", overflow: "hidden" }}
              >
                  ...
                  <div className="slider-item" key={index}>
                    <div className="slider-img-div">
                      <img
                        ...
                        onClick={() =>
                          dispatch({ type: "media", payload: elem.image })
                        }
                        src={elem.image}
                        alt="!Failed to open"
                      ></img>
                      {elem.available ? (
                        <div className="available-div available">
                          {" "}
                          <AiOutlineCheck />{" "}
                        </div>
                      ) : (
